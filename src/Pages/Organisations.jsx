...
import DM from "../assets/DM-II-grafika.png";
        ...
        <>
            ...
            {organisations ? (
                    <>
                            ...
                            <div>
                                <section
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                                        {organisations.realisation.map((e, i) => (
                                            <ArticleCard key={i} image={DM} rest={organisations.realisation[i]}/>
                                        ))}
                                    </div>
                                </section>
                                <section
                        ...
                        <Chat name={organisations.name} chat={organisations.chat}/>
                    </>
                ) :
                (
                    <div>Loading...</div>
