...
export default function SearchResultCard({title, description, tags, photo, className}) {
    return (
        <div className={className}>
            <div className=" cursor-pointer flex w-full h-32 bg-white rounded-lg text-gray-600 shadow-md hover:shadow-xl translate-y-1 hover:translate-y-0 transition ">
