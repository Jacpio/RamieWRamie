...
export default function ArticleCard({image, rest, className, index}) {
    ...
    return (
        <div ref={ref}>
            <div
                ...
                key={rest.id}
                className={`relative m-10 flex w-full max-w-md flex-col transition  overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md ${className}`}>
